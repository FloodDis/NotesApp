namespace NotesAppUI
{
	partial class AboutForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.linkLabel1.Location = new System.Drawing.Point(170, 150);
			this.linkLabel1.Name = "linkLabel1";
			this.linkLabel1.Size = new System.Drawing.Size(161, 18);
			this.linkLabel1.TabIndex = 4;
			this.linkLabel1.TabStop = true;
			this.linkLabel1.Text = "vlad.sechenov@mail.ru";
			// 
			// label5
			// 
			...
			this.linkLabel2.Location = new System.Drawing.Point(73, 186);
			this.linkLabel2.Name = "linkLabel2";
			this.linkLabel2.Size = new System.Drawing.Size(137, 18);
			this.linkLabel2.TabIndex = 6;
			this.linkLabel2.TabStop = true;
			this.linkLabel2.Text = "FloodDis/NotesApp";
			// 
			// label6
			// 
